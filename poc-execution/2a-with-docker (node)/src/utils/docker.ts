...
/**
 * Execute JS or TS code in a Docker container based on Node.js image, and log output to a temporary file. This allows to retrieve script output data even if the script times out.
