...
export type GetMySnippetsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMySnippetsQuery = { __typename?: 'Query', whoAmI?: { __typename?: 'User', snippets: Array<{ __typename?: 'Snippet', code: string, updatedAt: any, id: string, language: Language, name: string, slug: string, createdAt: any, executions?: Array<{ __typename?: 'Execution', status: ExecutionStatus, result: string, id: string, executedAt: any }> | null }> } | null };
