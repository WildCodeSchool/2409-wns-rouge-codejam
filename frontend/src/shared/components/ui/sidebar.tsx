...
function SidebarGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        'relative flex w-full min-w-0 flex-col p-2 pt-1',
        className,
      )}
      {...props}
    />
  ...
  const button = (
    <Comp
      ...
      className={cn(
        ...
        className,
        'hover:bg-transparent focus:bg-transparent focus:text-inherit focus-visible:ring-0 active:bg-transparent active:text-inherit',
      )}
      {...props}
    />
  )
